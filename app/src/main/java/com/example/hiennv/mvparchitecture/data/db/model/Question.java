...
public class Question {
    ...
    @Generated(hash = 121067325)
    public Question(int id, String questionText, String questionImgUrl,
    ...
    /*Can generate 2 constructor 1 co param, 1 k param, bo relation @ToMany*/
    public int getId() {
        return id;
    }
